...
Operations (26): getHealth, getReady, getOpenApi, getMetrics, toolsList, mcpToolsList, toolsCall, mcpToolsCall, mcpStreamableGet, mcpJsonRpc, mcpSessionDelete, auditQuery, auditExport, adminReload, adminListTenants, adminGetTenant, adminListSessions, adminDeleteSession, adminGetConfig, adminListWebhooks, getAdminAuditCsv, getAdminAuditMd, getAdminAuditHtml, getAdminAudit, adminRotateTenantToken, adminRotateTenantTokenByBody
